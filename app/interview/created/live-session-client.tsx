      ...
      {state === "ended" ? (
        ...
        <div className="session-notice">
          <p>
            ...
            answers. The interviewer has been asked to pause for a second or two
            to make sure you are done talking before moving on. Our interviewer
            can be curious, and although we have asked it to restrain its
            enthusiasm, if you feel it is asking too many follow-ups, feel free
            to say, &quot;we are done with this question, let&apos;s move on.&quot;
          </p>
        </div>
      )}

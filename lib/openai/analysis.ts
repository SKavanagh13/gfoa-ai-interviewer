...
function buildEligibilityPrompt(): string {
  return [
    ...
    "Use only segment_id values from the supplied segment map. If the transcript line begins with a label such as [0002], find the matching transcript_label row in the segment map and cite its segment_id. Do not cite transcript labels or sequence numbers such as 1, 2, 0002, or [0002].",
